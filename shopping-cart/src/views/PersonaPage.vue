  ...
  <ion-page>
    ...
    <ion-content>
      <div id="login-container">
        <div id="login-form">
          <InputComponent type="number" id="id" name="id" label="Id: "/>
            <InputComponent id="tipoDocumento" name="tipoDocumento" label="tipoDocumento: " />
            <InputComponent id="documento" name="documento" label="Documento: " />
            <InputComponent id="nombre" name="nombre" label="Nombre: " />
            <InputComponent id="telefono" name="telefono" label="Telefono: " />
...
// Rutas de la API
const baseURL = 'http://localhost:9000/estructura/api/persona';
